...
function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    fetch("https://script.google.com/macros/s/AKfycbwf_VT6VOE7dqOeyALRzLDYlVkrHBwuLrCMyIjAbFrK4KFJHSRBeHinaucCoZaU9w8D/exec"
      , {
        method: "POST",
  ...
  return (
    <>
      <section className="fp__breadcrumb" style={{ background: 'url(images/counter_bg.jpg)' }}>
        <div className="fp__breadcrumb_overlay">
          <div className="container">
            <div className="fp__breadcrumb_text">
              ...
              <ul>
                <li><a href="/">Home</a></li>
                <span><i className="fas fa-angle-right mr-4"></i></span>
      ...
      <section className="fp__contact mt_100 xs_mt_70 mb_100 xs_mb_70">
        <div className="container">
          <div className="row">
            ...
            <div className="col-xl-4 col-md-6 col-lg-4 wow fadeInUp" data-wow-duration="1s">
              <div className="fp__contact_info" style={{ display: 'flex !important' }}>
              ...
              <div className="col-xl-12 wow fadeInUp" data-wow-duration="1s">
                <form className="fp__contact_form" onSubmit={handleSubmit}>
                  ...
                  <div className="row">
                    ...
                    <div className="col-xl-6 col-lg-6">
                      <div className="fp__contact_form_input">
                        <span><i className="fal fa-book"></i></span>
                        <input
                          type="text"
                          name="subject"
                          placeholder="Subject"
