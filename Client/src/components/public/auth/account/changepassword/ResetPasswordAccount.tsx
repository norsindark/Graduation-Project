...
const ResetPasswordAccount = () => {
    ...
    const onFinish = async (values: { oldPassword: string, newPassword: string, confirmPassword: string }) => {
        ...
        if (newPassword === confirmPassword) {
            setIsSubmit(true);
            try {
                const response = await callChangePassword(userId, oldPassword, newPassword);
                        ...
                        <Form onFinish={onFinish} layout="vertical">
                            <div className="row">
                                <div className="col-xl-7">
                                    ...
                                    >
                                        <Input.Password placeholder="Old Password" autoComplete="old-password" />
                                    </Form.Item>
                                </div>
                                <div className="col-xl-7">
                                    <Form.Item
                            ...
                            <Button type="primary" shape="round" htmlType="submit" size="large" loading={isSubmit}>
                                <div className="text-[16px] font-medium text-center">Update Password</div>
                            </Button>
                        </Form>
                    </div>
                </div>
