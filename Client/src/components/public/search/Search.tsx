    ...
    return (
        <li className="md:px-1">
            ...
            <Modal
                ...
                closeIcon={
                    <div className="fp__menu_cart_header"><span className="close_cart" onClick={handleCancel}><i className="fal fa-times"></i></span></div>
                }
                                    ...
                                    <div key={index} className="col-xl-6 col-sm-6 col-lg-4 burger pizza wow fadeInUp"
                                        ...
                                        <div className="fp__menu_item">
                                            ...
                                            <div className="fp__menu_item_text">
                                                ...
                                                <a className="title" href="menu_details.html">{item.title}</a>
