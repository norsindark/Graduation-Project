...
public interface OrderRepository extends JpaRepository<Order, String> {
    ...
    @Query("SELECT new com.restaurant_management.payloads.responses.StatisticResponse(SUM(o.totalPrice), COUNT(o)) FROM Order o")
    StatisticResponse getTotalRevenue();
}
